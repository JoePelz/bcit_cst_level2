...
public class ImprovedFormattedTextField extends JFormattedTextField {
    ...
    /** Color of the background during an error. */
    ...
    /**
     * Add a document listener to the field to enable 
     * actions being triggered when the text is changed.
     */
    ...
    /**
     * Check if the current content validates.
     * 
    ...
    /**
     * This class listens to focus changes to restore the caret position
